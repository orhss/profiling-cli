...
async def create_pr_with_optimized_function(agent_executor: AgentExecutor) -> None:
    ...
    2. Use create_branch to make a new branch from main, you must add a truly generated random 8 letter code to the branch name, do not use predetermined sequences.    
